...
public final class ScreenUtils {
     ...
     * @return the application's height of screen, in pixel
     */
    public static int getAppScreenHeight(Application application) {
        WindowManager wm = (WindowManager) application.getSystemService(Context.WINDOW_SERVICE);
        if (wm == null) {
            return -1;
        }
     ...
     * @return {@code true}: yes<br>{@code false}: no
     */
    public static boolean isPortrait(Application application) {
        return application.getResources().getConfiguration().orientation
     ...
     * @return {@code true}: yes<br>{@code false}: no
     */
    public static boolean isScreenLock(Application application) {
        KeyguardManager km =
    ...
    public static void setSleepDuration(Application application, final int duration) {
     ...
     * @return the duration of sleep.
     */
    public static int getSleepDuration(Application application) {
        try {
